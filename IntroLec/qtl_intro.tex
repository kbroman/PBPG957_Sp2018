...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/pbpg2018intro}{\tt \scriptsize
  \color{foreground} bit.ly/pbpg2018intro}
}
...
\frame{
  ...
  \note{These are slides for a talk introducing QTL mapping for the
    2018 Plant Breeding and Plant Genetics seminar course, on 26 Jan 2018

    Source: {\tt https://github.com/kbroman/PlantBreeding2018} \\
    Slides: {\tt http://bit.ly/pbpg2018intro}
    }
...
\begin{frame}[c]{Key challenges in QTL mapping}

  \bbi
\item Multiple phenotypes
  \bi
\item Consider jointly to refine QTL location
\item Common or separate QTL?
\item Tease apart cause
  \ei
\item QTL $\times$ environment interactions
\item Analysis methods for multi-parent populations
\item Data diagnostics
\item Data, software, and results management
